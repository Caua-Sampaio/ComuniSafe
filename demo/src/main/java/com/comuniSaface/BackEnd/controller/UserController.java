...
import com.comuniSaface.BackEnd.dto.UserDTO;
import com.comuniSaface.BackEnd.dto.UserMinDTO;
import com.comuniSaface.BackEnd.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<UserDTO> me(HttpSession session) {
        ...
        // reforçar que senha não será retornada
        //GAMBIARRA DETECATA
        user.setSenha(null);
